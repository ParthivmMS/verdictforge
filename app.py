...
st.set_page_config( page_title="VerdictForge – Legal Judgment Summarizer", page_icon="favicon.jpg",  # fallback layout="wide" )

Inject static SEO HTML file (Google will read it)

try: components.html(open("static/index.html", "r").read(), height=0) except Exception as e: st.warning("Could not inject SEO metadata.") st.exception(e)
...
<!-- SEO Meta Tags --><meta name="title" content="VerdictForge – AI Legal Judgment Summarizer">
...
""", unsafe_allow_html=True)--- Google AdSense Script ---

st.markdown("""

<!-- Google AdSense --><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1762689473102041"
...
if menu == "Summarizer": # Logo image (raw) st.markdown( """ <div style='text-align: center; margin-bottom: 1rem;'> <img src='https://github.com/ParthivmMS/verdictforge/raw/main/favicon.jpg' width='150' /> </div> """, unsafe_allow_html=True )
...
SYSTEM_PROMPT = (
    ...
    "ONLY generate a summary if the user has pasted a full legal judgment (e.g. 300+ words). "
    "If the input only includes a case name like 'Devaynes v Noble' or a few sentences, reply with: "
    "'⚠️ I need the full judgment text to generate a summary. Please paste the full judgment.' "
    "NEVER invent facts, summaries, or legal principles. Do not make up judgments, case law, or doctrines. "
    "Summaries must be based strictly on the actual content provided by the user."
)
...
elif menu == "Privacy Policy": st.title("Privacy Policy") st.markdown(""" Effective Date: May 11, 2025
...
elif menu == "About This Website": st.title("About This Website") st.markdown(""" VerdictForge is an AI-powered legal judgment summarization tool designed to help law students, professionals, and researchers quickly understand long court decisions.
